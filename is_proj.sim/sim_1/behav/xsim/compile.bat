...
REM
REM Generated by Vivado on Thu Dec 11 11:34:25 +0800 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_MaxBubble_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_MaxBubble_vlog.prj -log xvlog.log
