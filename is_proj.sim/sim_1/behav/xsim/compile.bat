...
REM
REM Generated by Vivado on Tue Sep 30 16:35:14 +0800 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_ZoneIDMulticast_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_ZoneIDMulticast_vlog.prj -log xvlog.log
