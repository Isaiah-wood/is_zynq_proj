...
REM
REM Generated by Vivado on Tue Dec 09 16:51:58 +0800 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_VecPopcount_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_VecPopcount_vlog.prj -log xvlog.log
