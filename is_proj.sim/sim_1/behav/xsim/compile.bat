...
REM
REM Generated by Vivado on Tue Nov 25 10:26:19 +0800 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_axi_ddr3_sim_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_axi_ddr3_sim_vlog.prj -log xvlog.log
