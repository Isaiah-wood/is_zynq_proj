...
HD_PWD='C:/Users/Administrator/Documents/Vivado/is_proj/is_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZoneIDMulticast.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZoneIDMulticast.tcl
